...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:3001",
        "http://localhost:3000",
        "https://ascendai-cambridge.netlify.app",
...
# Note Summariser — turns Google Classroom posts into structured
# study notes via Groq, triggers n8n sync, and lists saved notes.
# Three endpoints:
# POST /notes/summarise  (called by n8n for each new post),
...
# In-app notification bell — list, mark read, mark all read.
app.include_router(
